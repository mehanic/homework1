...
output "eks_fargate_profile_arn" {
  ...
  value       = module.eks.eks_fargate_profile_arn
}

output "eks_fargate_profile_id" {
  description = "EKS Cluster name and EKS Fargate Profile name separated by a colon (:)."
  value       = module.eks.eks_fargate_profile_id
}

output "eks_fargate_profile_status" {
  description = "Status of the EKS Fargate Profile."
  value       = module.eks.eks_fargate_profile_status
}
...
output "private_subnets_owner_id" {
  ...
  value       = module.vpc.private_subnets_owner_id
}
...
output "public_subnets_owner_id" {
  description = "The ID of the AWS account that owns the subnet."
  value       = module.vpc.public_subnets_owner_id
}
...
output "internet_gateway_owner_id" {
  ...
  value       = module.vpc.internet_gateway_owner_id
}
...
output "vpc_dhcp_options_owner_id" {
  ...
  value       = module.vpc.vpc_dhcp_options_owner_id
}
...
output "nat_gateway_allocation_id" {
  ...
  value       = module.vpc.nat_gateway_allocation_id
}
...
output "nat_gateway_network_interface_id" {
  ...
  value       = module.vpc.nat_gateway_network_interface_id
}
...
output "nat_eip_associate_with_private_ip" {
  ...
  value       = module.vpc.nat_eip_associate_with_private_ip
}

output "nat_eip_tags" {
  description = "(Optional) A mapping of tags to assign to the resource."
  value       = module.vpc.nat_eip_tags
}
...
output "nat_eip_public_ipv4_pool" {
  ...
  value       = module.vpc.nat_eip_public_ipv4_pool
}
